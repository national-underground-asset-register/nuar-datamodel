...
CREATE TABLE nuardata.relationship_networktocontactdetails (
...
CREATE TABLE nuardata.relationship_objecttoenclosingobject (
...
CREATE TABLE nuarorganisations.relationship_ruletonotification (
   ...
   geographicalextent geometry(GEOMETRY,27700),
   dataproviderid_fk character varying(38) NOT NULL,
   submissioneventid_fk character varying(38) NOT NULL
);
...
ALTER TABLE nuardata.relationship_networktocontactdetails ADD CONSTRAINT fk_nuardata_relationship_networktocontactdetails_dataproviderid FOREIGN KEY (dataproviderid_fk) REFERENCES nuarorganisations.nuaractor;
ALTER TABLE nuardata.relationship_networktocontactdetails ADD CONSTRAINT fk_nuardata_relationship_networktocontactdetails_submissioneven FOREIGN KEY (submissioneventid_fk) REFERENCES nuarsubmissions.nuarsubmissionevent;
...
ALTER TABLE nuardata.relationship_objecttoenclosingobject ADD CONSTRAINT fk_nuardata_relationship_objecttoenclosingobject_dataproviderid FOREIGN KEY (dataproviderid_fk) REFERENCES nuarorganisations.nuaractor;
ALTER TABLE nuardata.relationship_objecttoenclosingobject ADD CONSTRAINT fk_nuardata_relationship_objecttoenclosingobject_submissioneven FOREIGN KEY (submissioneventid_fk) REFERENCES nuarsubmissions.nuarsubmissionevent;
...
CREATE INDEX idx_nuarorganisations_relationship_ruletonotification_geographi ON nuarorganisations.relationship_ruletonotification USING GIST (geographicalextent);
